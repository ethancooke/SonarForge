...
> Stability and safety follow-up to v0.2.0 — preamp persistence, digital clip metering, clearer permission recovery, and polish.
...
- Engine **permission preflight** before Core Audio start; clearer **Starting… / timeout / denied** recovery (Privacy Settings, Troubleshooting, `tccutil` tip when relevant).
...
- UI polish: factory count copy, Flat reset by stable id, menu-bar Bypass aligned with main window, compact output meter with correct full-track colors.
